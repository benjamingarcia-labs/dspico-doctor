# DSpico Doctor Research

This directory contains research and technical notes used to guide DSpico Doctor decisions and contributions.
...
Explains how the major DSpico components interact, including the RP2040 firmware, embedded bootloader, Pico Loader, Pico Launcher, DLDI, cartridge communication, and microSD read path.
